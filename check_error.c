...
/**
 * error_sep_op - it finds syntax errors
 * @input: the input string
 * @i: the index
 * @last: the last char read
 * Return: returns index of error. 0 when there are no
 * errors
 */
...
/**
 * first_char - the finds index of the first char
 * @input: the input string
 * @i: the index
...
void print_syntax_error(data_shell *datash, char *input, int i, int bool)
{
	...
	msg2 = ": Syntax error: \"";
	msg3 = "\" unexpected\n";
	counter = hsh_itoa(datash->counter);
...
/**
 * check_syntax_error - it intermediate function to
